...
export default function Roles() {
  ...
  const roles = [
    ...
    },
    {
      ...
      extendedDesc: "Optimize your supply chain with our operations specialists. We help manage inventory levels, coordinate with suppliers, track shipments, and ensure your logistics run smoothly from warehouse to customer doorstep.",
      image: "/images/role-logistics.png",
      cta: "Hire Ops Manager",
      icon: (
        <svg className="w-6 h-6 lg:w-8 lg:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1-1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1m-4-1a1 1 0 00-1 1H4a1 1 0 00-1-1v-1" />
        </svg>
      )
    },
    {
      ...
      extendedDesc: "Scale your healthcare practice with specialized administrative support. Our team handles patient inquiries, appointment scheduling, insurance verification, and medical billing while maintaining the highest standards of data privacy.",
    ...
    },
    {
      ...
      extendedDesc: "Have a unique requirement? We source specialized talent across various niche industries, including legal support, technical research, content moderation, and more. Tell us what you need, and we'll find the expert.",
  ...
  return (
    <section id="roles" className="py-[var(--section-py)] bg-[#fdfcfb]">
      <div className="container mx-auto px-4 max-w-[var(--container-max)]">
        <h2 className="text-3xl lg:text-[clamp(2.5rem,5vw,3.5rem)] font-black text-center text-gray-900 mb-10 lg:mb-16 tracking-tight">
          Roles We Can Fill
        </h2>
