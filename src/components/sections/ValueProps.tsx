...
export default function ValueProps() {
  ...
  return (
    <section id="why" className="py-[var(--section-py)] bg-white overflow-hidden">
      <div className="container mx-auto px-6 max-w-[var(--container-max)]">
        <div className="flex flex-col lg:flex-row items-center gap-[var(--section-gap)]">
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="relative rounded-[1.5rem] lg:rounded-[2.5rem] overflow-hidden shadow-2xl">
              ...
              <div className="absolute top-3 left-3 right-3 md:top-8 md:left-8 md:right-auto md:w-80 bg-white/95 backdrop-blur-md p-4 lg:p-6 rounded-xl lg:rounded-2xl shadow-xl border border-white/20 animate-in fade-in slide-in-from-left-4 duration-1000" style={{ WebkitBackdropFilter: 'blur(12px)' }}>
                <h4 className="text-[0.6875rem] lg:text-sm font-bold text-gray-900 mb-3 lg:mb-4">Talent Quality Overview</h4>
                <div className="space-y-2 lg:space-y-4">
                  {[
                    ...
                    <div key={metric.name}>
                      <div className="flex justify-between text-[0.5rem] lg:text-[0.625rem] font-bold mb-1 uppercase tracking-wider text-gray-500">
          ...
          <div className="w-full lg:w-1/2 text-left">
            <h2 className="text-3xl lg:text-[clamp(2.5rem,5vw,3.5rem)] font-black text-gray-900 mb-5 lg:mb-6 leading-tight tracking-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8">
              {stats.map((stat) => (
                <div key={stat.label} className="flex sm:block items-center gap-4">
                  <div className="text-3xl lg:text-4xl font-black text-gray-900 mb-0 lg:mb-1 min-w-[5rem] sm:min-w-0">{stat.value}</div>
                  <div className="text-[0.6875rem] lg:text-xs font-bold text-gray-500 uppercase tracking-widest leading-tight">
